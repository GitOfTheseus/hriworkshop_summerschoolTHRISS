...
#######################################################################################
   ...
   moving_torso_right() {
	echo "ctpq time $1 off 0 pos (1.923077 -20.604396 -15.009011)" | yarp rpc /ctpservice/torso/rpc
      ...
      moving_torso_forward() {
	echo "ctpq time $1 off 0 pos (-3 0 5)" | yarp rpc /ctpservice/torso/rpc
...
#######################################################################################
    explain_skin_forearm() {
	 ...
	 speak "Con la mia pelle artificiale posso sentire quando mi tocchi" 
	 sleep 3.0 
	 guarda_front
	 go_home
	 speak "Guarda come si illumina sullo schermo!" 
	 sleep 6.0
   ...
   present_movements() {
   	sleep 1.0
	speak "Ho 41 motori che mi permettono di muovere il mio corpo nello spazio!"
	sleep 5.0
	explain_balancing
	sleep 7.0
	explain_compliance
...
#######################################################################################
    explain_eyes() {
	 ...
	 speak "Questi sono i miei occhi, due telecamere con cui posso vedere il mondo"
         ...
         #guarda_front 
         go_home
         speak "E posso anche individuare il tuo volto nello spazio."
         guarda_r
         sleep 2.0
         guarda_l
         sleep 2.0
         guarda_front
         sleep 2.0
         moving_torso_forward 2.0       
         speak "Prova ad avvicinarti cosi' te lo mostro!"
         sleep 6.0 
         #guarda_front 
         go_home
         smile
...
#######################################################################################
   ...
   guarda_leftarm(){
	echo "abs -15 -15 0" | yarp write ... /iKinGazeCtrl/angles:i 

   }
   
   guarda_righteyes(){
	echo "abs 15 -10 0" | yarp write ... /iKinGazeCtrl/angles:i 

   }
   
   guarda_r(){
	echo "abs 15 0 0" | yarp write ... /iKinGazeCtrl/angles:i 
   ...
   guarda_down(){
	echo "abs 0 -15 0" | yarp write ... /iKinGazeCtrl/angles:i 
   ...
   intro(){
	...
	#saluta
	#sleep 2.0
	#speak "Spero che verrete presto a trovarmi"
    }
    ...
    intro_p1()
    {
    	saluta_classic
    	sleep 3.0
    	speak "Sono il robot dell' Istituto Italiano di Tecnologia di Genova."
    	sleep 5.0
    	speak "Benvenuti al centro di ricerca di Erzelli."
    	sleep 5.0
    	speak "Oggi vi raccontero' cosa posso fare."
    	sleep 4.0
	speak "I ricercatori I I T mi hanno dotato di strumenti per interagire con gli esseri umani."
	sleep 6.0
      ...
      intro_p3()
    {
    	...
    	present_emotions
    	speak "e so anche riconoscere le espressioni facciali di voi umani!"
	sleep 7.0
	
	speak "La mia presentazione è finita. E' stato bello conoscervi"
	sleep 5.0
	
	speak "Ora dovrete compilare un'altra parte del questionario."
	sleep 4.0
	speak "Quando avrete tutti finito, le ricercatrici potranno rispondere alle vostre curiosita'. "
	sleep 6.0
	speak "Ciao ciao!"
	saluta
	sleep 8.0
      ...
      intro_bimbo1()
    {
    	...
    	sleep 5.0
    	smile
    	speak "Benvenuto al centro di ricerca di Erzelli."
    	guarda_r
        sleep 2.0
        guarda_l
        sleep 2.0
        guarda_front
        sleep 2.0
    	speak "Oggi ti raccontero' cosa posso fare."
    	sleep 4.0
    	smile
    	sleep 1.0
	speak "I ricercatori I I T mi hanno dotato di strumenti per interagire con gli esseri umani."
	...
	speak "La mia presentazione è finita. E' stato bello conoscerti"
	sleep 5.0
	
	speak "Ora dovrai compilare un'altra parte del questionario."
	sleep 4.0
	speak "Quando avrai finito, le ricercatrici potranno rispondere alle vostre curiosita'. "
	sleep 6.0
	smile
	speak "Ciao ciao!"
	saluta
