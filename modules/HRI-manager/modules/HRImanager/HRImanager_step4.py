        ...
        if self.current_state == State.WAITING_FOR_STIMULI:
            ...
            for obj in self.object_class_list:
                ...
                if obj in list(self.object_class_dict.keys()):
                    ...
                    self.object_name = self.memory.retrieve_info_by_info('direction', self.object_direction, 'name')
            ...
            self.action.speak(self.memory.retrieve_information(self.object_category, 'name'))
